...
class Shifter_Redirects_Public {
	...
	public function shifter_redirects_header() {
		?>
				...
				const source = "<?php echo esc_attr( get_option( 'shifter_redirects_source' ) ); ?>";
				const destination = "<?php echo esc_attr( get_option( 'shifter_redirects_destination' ) ); ?>";
				const status = "<?php echo esc_attr( get_option( 'shifter_redirects_status' ) ); ?>";
