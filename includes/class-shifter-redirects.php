...
class Shifter_Redirects {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Shifter_Redirects_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'SHIFTER_REDIRECTS_VERSION' ) ) {
			$this->version = SHIFTER_REDIRECTS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'shifter-redirects';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-shifter-redirects-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-shifter-redirects-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-shifter-redirects-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-shifter-redirects-public.php';

		$this->loader = new Shifter_Redirects_Loader();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Shifter_Redirects_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Shifter_Redirects_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Shifter_Redirects_Loader    Orchestrates the hooks of the plugin.
	 */
